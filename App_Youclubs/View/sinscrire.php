...
<?php 
  ...
  <label class="btn btn-light active">
    <input type="radio" name="options" id="option1" onclick="window.location.href='./seconnecter.php'"> Se connecter
  </label>
...
<form action="./includes/sinscrire.inc.php" method="post">
...
.</small>
  ...
  <div class="form-group form-check">
    ...
    <label class="form-check-label" for="exampleCheck1">J'accepte de partager mes données avec nous. Je reconnais que le
la collecte et l'utilisation de mes données personnelles suivront
le traitement tel que décrit dans leurs politiques de confidentialité </label>
  </div>
  <button type="submit" name="sinscrire-submit" class="btn btn-primary" style="  position: absolute; margin-left: 200px; border-radius: 2em;">Se connecter</button>
</form>
</div>
