...
<body>
    ...
    <section class="Part_event">
        ...
        <div class="tri">
            <div class="triAll">
                <select id="tri_date">
                    <option hidden disabled selected value="valeur1">Tri par date</option> 
                    <option value="valeur2" >Valeur 2</option>
                    <option value="valeur3">Valeur 3</option>
                </select>
                <select id="tri_date">
                    <option  hidden disabled selected value="valeur1">Tri par club</option> 
                    <option value="valeur2" >Valeur 2</option>
                    <option value="valeur3">Valeur 3</option>
                </select>
                <button class="btnSearch"> <img src="../Public/Images/search.png" height="30px" width="30px" alt="search"></button>
            </div>
        </div>
